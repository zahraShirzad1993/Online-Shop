        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobileActiveCode = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    benefitPrcie = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_prodcuts_OrderDetails_OrderDetailId",
                        column: x => x.OrderDetailId,
                        principalTable: "OrderDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_prodcuts_ProductCategories_productCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_prodcuts_OrderDetailId",
                table: "prodcuts",
                column: "OrderDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_prodcuts_productCategoryId",
                table: "prodcuts",
